...
from controllers.property import properties,property_detail,delete_property,get_property
...
app_bp.route('/property/<int:property_id>',methods= ['GET','POST'])(get_property)